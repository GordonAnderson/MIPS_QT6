...
public:
    ...
    void setupUi(QMainWindow *MIPS)
    {
        ...
        actionLoad_Plot = new QAction(MIPS);
        actionLoad_Plot->setObjectName("actionLoad_Plot");
        centralWidget = new QWidget(MIPS);
        centralWidget->setObjectName("centralWidget");
        tabMIPS = new QTabWidget(centralWidget);
        tabMIPS->setObjectName("tabMIPS");
        tabMIPS->setGeometry(QRect(-5, 15, 796, 571));
        tabMIPS->setTabShape(QTabWidget::TabShape::Rounded);
        System = new QWidget();
        ...
        lblMIPSconfig->setGeometry(QRect(380, 60, 361, 471));
        ...
        comboMIPSnetNames->setInsertPolicy(QComboBox::InsertPolicy::InsertAtTop);
        ...
        label_220 = new QLabel(ADC);
        label_220->setObjectName("label_220");
        label_220->setGeometry(QRect(40, 450, 721, 81));
        ...
        frmCVparking->setFrameShape(QFrame::Shape::NoFrame);
        frmCVparking->setFrameShadow(QFrame::Shadow::Plain);
        ...
        textCVparkList->setLineWrapMode(QTextEdit::LineWrapMode::NoWrap);
        ...
        menuFile->addAction(actionLoad_Plot);
    ...
    void retranslateUi(QMainWindow *MIPS)
    {
        ...
        actionLoad_Plot->setText(QCoreApplication::translate("MIPS", "Load Plot", nullptr));
...
"", nullptr));
        ...
        label_220->setText(QCoreApplication::translate("MIPS", "This interface enables you to utilize the ADC as a digitizer, allowing you to transmit data from the MIPS system to the host computer. It supports sampling rates up to 1MHz and long total vector lengths. To begin, enter your desired parameters and press the ADC setup button. Subsequently, press the trigger button to acquire a vector. If you\342\200\231ve selected multiple vectors, press the trigger button until you receive the recording complete message.", nullptr));
