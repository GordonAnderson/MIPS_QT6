...
void TimingGenerator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotEventChange(); break;
        case 2: _t->slotEventUpdated(); break;
        case 3: _t->slotGenerate(); break;
        case 4: _t->slotClearEvents(); break;
        case 5: _t->slotLoad(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TimingGenerator::*)(QString );
            if (_t _q_method = &TimingGenerator::change; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TimingGenerator::change(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
